const ICONS = {
  ...
  'dien-thoai-cu-99': '<svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><rect x="7" y="2" width="10" height="20" rx="2" stroke="currentColor" stroke-width="1.5"/><line x1="7" y1="18" x2="17" y2="18" stroke="currentColor" stroke-width="1.5"/></svg>',
  samsung: '<svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><rect x="7" y="2" width="10" height="20" rx="2" stroke="currentColor" stroke-width="1.5"/><line x1="7" y1="18" x2="17" y2="18" stroke="currentColor" stroke-width="1.5"/></svg>'
};
